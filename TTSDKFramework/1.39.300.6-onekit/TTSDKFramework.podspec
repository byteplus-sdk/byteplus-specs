Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.39.300.6-onekit/TTSDKFramework-1.39.300.6-onekit-ta.zip", :type => :zip }
