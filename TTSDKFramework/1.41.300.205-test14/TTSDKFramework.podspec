Pod::Spec.new do |spec|
  ...
  spec.version = "1.41.300.205-test14"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.41.300.205-test14/TTSDKFramework-1.41.300.205-test14-ta.zip", :type => :zip }
