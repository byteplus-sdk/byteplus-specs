Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.40.200.5-standard/TTSDKFramework-1.40.200.5-standard-ta.zip", :type => :zip }
