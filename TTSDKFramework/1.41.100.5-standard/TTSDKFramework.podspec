Pod::Spec.new do |spec|
  ...
  spec.version = "1.41.100.5-standard"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.41.100.5-standard/TTSDKFramework-1.41.100.5-standard-ta.zip", :type => :zip }
