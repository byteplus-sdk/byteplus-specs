Pod::Spec.new do |spec|
  ...
  spec.version = "1.41.300.205-test13"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.41.300.205-test13/TTSDKFramework-1.41.300.205-test13-ta.zip", :type => :zip }
  ...
  spec.subspec 'Core' do |subspec|
    ...
    unless $DoNotInstallApplogVersion == "6.16.8"
      ...
      subspec.dependency 'RangersAppLog/Host/SG', '~> 6.16.8'
    end
