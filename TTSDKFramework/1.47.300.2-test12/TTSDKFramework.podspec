Pod::Spec.new do |spec|
  ...
  spec.version = "1.47.300.2-test12"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.47.300.2-test12/TTSDKFramework-1.47.300.2-test12-ta.zip", :type => :zip }
