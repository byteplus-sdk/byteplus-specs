Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.45.100.1-test1/TTSDKFramework-1.45.100.1-test1-ta.zip", :type => :zip }
