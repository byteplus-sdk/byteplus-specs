Pod::Spec.new do |spec|
  ...
  spec.version = "1.44.200.4-standard-arm64"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.44.200.4-standard-arm64/TTSDKFramework-1.44.200.4-standard-arm64-ta.zip", :type => :zip }
