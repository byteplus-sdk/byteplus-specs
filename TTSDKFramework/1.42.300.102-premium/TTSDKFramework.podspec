Pod::Spec.new do |spec|
  ...
  spec.version = "1.42.300.102-premium"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.42.300.102-premium/TTSDKFramework-1.42.300.102-premium-ta.zip", :type => :zip }
