Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.50.200.1-test/TTSDKFramework-1.50.200.1-test-ta.zip", :type => :zip }
