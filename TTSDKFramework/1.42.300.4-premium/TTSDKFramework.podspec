Pod::Spec.new do |spec|
  ...
  spec.version = "1.42.300.4-premium"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.42.300.4-premium/TTSDKFramework-1.42.300.4-premium-ta.zip", :type => :zip }
