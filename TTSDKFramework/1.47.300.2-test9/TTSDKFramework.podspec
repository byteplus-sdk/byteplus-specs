Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.47.300.2-test9/TTSDKFramework-1.47.300.2-test9-ta.zip", :type => :zip }
