Pod::Spec.new do |spec|
  ...
  spec.version = "1.45.200.7-standard"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.45.200.7-standard/TTSDKFramework-1.45.200.7-standard-ta.zip", :type => :zip }
