Pod::Spec.new do |spec|
  ...
  spec.version = "1.41.300.205-test15"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.41.300.205-test15/TTSDKFramework-1.41.300.205-test15-ta.zip", :type => :zip }
