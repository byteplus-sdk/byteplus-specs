Pod::Spec.new do |spec|
  ...
  spec.version = "1.42.300.2-premium"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.42.300.2-premium/TTSDKFramework-1.42.300.2-premium-ta.zip", :type => :zip }
