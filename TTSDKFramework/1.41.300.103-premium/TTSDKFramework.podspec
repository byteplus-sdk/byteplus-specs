Pod::Spec.new do |spec|
  ...
  spec.version = "1.41.300.103-premium"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.41.300.103-premium/TTSDKFramework-1.41.300.103-premium-ta.zip", :type => :zip }
