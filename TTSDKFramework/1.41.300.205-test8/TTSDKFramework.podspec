Pod::Spec.new do |spec|
  ...
  spec.version = "1.41.300.205-test8"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.41.300.205-test8/TTSDKFramework-1.41.300.205-test8-ta.zip", :type => :zip }
