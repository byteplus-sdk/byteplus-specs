Pod::Spec.new do |spec|
  ...
  spec.version = "1.47.300.1-standard"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.47.300.1-standard/TTSDKFramework-1.47.300.1-standard-ta.zip", :type => :zip }
