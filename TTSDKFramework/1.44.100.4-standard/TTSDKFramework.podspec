Pod::Spec.new do |spec|
  ...
  spec.version = "1.44.100.4-standard"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.44.100.4-standard/TTSDKFramework-1.44.100.4-standard-ta.zip", :type => :zip }
