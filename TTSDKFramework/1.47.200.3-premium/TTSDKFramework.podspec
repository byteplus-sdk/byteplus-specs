Pod::Spec.new do |spec|
  ...
  spec.version = "1.47.200.3-premium"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.47.200.3-premium/TTSDKFramework-1.47.200.3-premium-ta.zip", :type => :zip }
