Pod::Spec.new do |spec|
  ...
  spec.version = "1.41.300.101-tv360"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.41.300.101-tv360/TTSDKFramework-1.41.300.101-tv360-ta.zip", :type => :zip }
