Pod::Spec.new do |spec|
  ...
  spec.version = "1.48.100.5-premium"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.48.100.5-premium/TTSDKFramework-1.48.100.5-premium-ta.zip", :type => :zip }
