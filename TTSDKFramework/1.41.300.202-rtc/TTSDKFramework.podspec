Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.41.300.202-rtc/TTSDKFramework-1.41.300.202-rtc-ta.zip", :type => :zip }
