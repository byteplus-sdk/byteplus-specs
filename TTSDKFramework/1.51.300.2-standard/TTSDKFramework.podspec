Pod::Spec.new do |spec|
  ...
  spec.version = "1.51.300.2-standard"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.51.300.2-standard/TTSDKFramework-1.51.300.2-standard-ta.zip", :type => :zip }
