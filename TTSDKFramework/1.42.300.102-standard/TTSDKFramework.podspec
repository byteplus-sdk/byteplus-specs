Pod::Spec.new do |spec|
  ...
  spec.version = "1.42.300.102-standard"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.42.300.102-standard/TTSDKFramework-1.42.300.102-standard-ta.zip", :type => :zip }
