Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.41.3.6-rc/TTSDKFramework-1.41.3.6-rc-ta.zip", :type => :zip }
