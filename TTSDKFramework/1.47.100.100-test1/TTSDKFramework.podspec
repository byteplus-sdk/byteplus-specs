Pod::Spec.new do |spec|
  ...
  spec.version = "1.47.100.100-test1"
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.47.100.100-test1/TTSDKFramework-1.47.100.100-test1-ta.zip", :type => :zip }
