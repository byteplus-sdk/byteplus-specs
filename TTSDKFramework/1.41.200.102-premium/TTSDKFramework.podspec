Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDKFramework/1.41.200.102-premium/TTSDKFramework-1.41.200.102-premium-ta.zip", :type => :zip }
