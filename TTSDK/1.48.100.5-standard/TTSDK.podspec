  Pod::Spec.new do |spec|
    spec.name         = "TTSDK"
    spec.version      = "1.48.100.5-standard"
    ...
    spec.source       = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDK/1.48.100.5-standard/TTSDK-1.48.100.5-standard.zip" }
