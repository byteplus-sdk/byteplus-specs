  Pod::Spec.new do |spec|
    spec.name         = "TTSDK"
    spec.version      = "1.41.200.102-premium"
    ...
    spec.source       = { :http => "https://lf16-bpsdk.bytepluscdn.com/obj/byteplussdk-sg/TTSDK/1.41.200.102-premium/TTSDK-1.41.200.102-premium.zip" }
    ...
    spec.subspec 'Player' do |subspec|
      class_name = 'TTVideoEngine,ABRInterface,TTNetworkPredict,VCVodSettings'
      subspec.public_header_files = [
        "TTSDK/{#{class_name}}/**/*.h"
      ]
      subspec.source_files = [
